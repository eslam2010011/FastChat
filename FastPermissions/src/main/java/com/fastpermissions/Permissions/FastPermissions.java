...
public class FastPermissions {
  ...
  private static class ActivityPermissionObject extends PermissionObject {
    ...
    public boolean hasAll(String... permissions) {
      return FastPermissions.hasAll(activity, permissions);
    }

    @Override
    public void requestPermissions(int requestCode, String... permissions) {
      FastPermissions.requestPermissions(activity, requestCode, permissions);
    }
  }
  ...
  private static class FragmentPermissionObject extends PermissionObject {
    ...
    @Override
    public boolean hasAll(String... permissions) {
      return FastPermissions.hasAll(fragment.getContext(), permissions);
    }

    @Override
    public void requestPermissions(int requestCode, String... permissions) {
      FastPermissions.requestPermissions(fragment, requestCode, permissions);
    }
  }
